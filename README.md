...
Simple, yet powerful, MySQL report generator. Reports can be saved to .csv, .html, .txt, .xls, and .xml formats. To see Sqlseer in action, please visit [sqlseer.smithii.com](http://sqlseer.smithii.com/)
